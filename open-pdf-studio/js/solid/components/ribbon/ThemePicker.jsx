...
const THEME_OPTIONS = [
  { value: 'default', labelKey: 'theme.default', swatches: ['#36363E', '#44444C', '#D97706', '#FAFAF9'] },
  ...
  { value: 'warm-ember', labelKey: 'theme.warmEmber', swatches: ['#3E3636', '#4a4242', '#D97706', '#F5F0EB'] },
